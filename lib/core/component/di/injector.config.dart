...
import 'package:app_links/app_links.dart' as _i4;
...
import '../storage/part.dart' as _i5;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i4.AppLinks>(() => registerModule.appLinks);
  gh.singleton<_i5.CacheStorage>(() => registerModule.secureStorage);
  gh.singleton<_i6.AppRouter>(() => _i6.AppRouter());
  gh.singleton<_i7.Utils>(() => const _i7.Utils());
  gh.singleton<_i8.SummaryTokenRepository>(
      () => _i8.SummaryTokenRepositoryImpl(gh<_i5.CacheStorage>()));
  gh.singleton<_i8.TokenRepository>(
      () => _i8.TokenRepository(gh<_i5.CacheStorage>()));
  gh.singleton<_i8.LanguageRepository>(
      () => _i8.LanguageRepository(storage: gh<_i5.CacheStorage>()));
