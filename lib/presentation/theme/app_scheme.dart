...
class AppSchemeDark {
  ...
  static final AppColorsExtension colors = AppColorsExtension(
    ...
    progressTrackColor: const .new(0x332196F3),
    sorbus: const .new(0xFFFF9F40),
    portage: const .new(0xFF5CADFF),
    mulberry: const .new(0xFFE064B7),
    apple: const .new(0xFF7EEC97),
    deluge: const .new(0xFFA0A1D7),
    scarlet: const .new(0xFFF47676),
